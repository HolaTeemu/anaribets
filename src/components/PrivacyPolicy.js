const PrivacyPolicy = () => {
  return (
    <div class="w-4/5 mx-auto my-10">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to BetNHLFree.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to BetNHLFree, accessible from{" "}
            <a
              href="https://betnhlfree.com/"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://betnhlfree.com/
            </a>
          </p>
        </li>
        <li>
      ...
      <br />
      <ul>
        <li>By email: teemu.holappa97@gmail.com</li>
      </ul>
    </div>
  );
};
