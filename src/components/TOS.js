const TOS = () => {
  return (
    <div class="w-4/5 mx-auto my-10">
      ...
      <br />
      <p>Welcome to BetNHLFree!</p>
      <br />
      <p>
        These terms and conditions outline the rules and regulations for the use
        of BetNHLFree's Website, located at https://betnhlfree.com/.
      </p>
      <br />
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use BetNHLFree if you do not agree to
      ...
      <br />
      <p>
        We employ the use of cookies. By accessing BetNHLFree, you agreed to use
        cookies in agreement with the BetNHLFree's Privacy Policy.{" "}
      </p>
      <br />
      <p>
      ...
      <br />
      <p>
        Unless otherwise stated, BetNHLFree and/or its licensors own the
        intellectual property rights for all material on BetNHLFree. All
        intellectual property rights are reserved. You may access this from
        BetNHLFree for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>
      <br />
      <p>You must not:</p>
      <ul>
        <li>Republish material from BetNHLFree</li>
        <li>Sell, rent or sub-license material from BetNHLFree</li>
        <li>Reproduce, duplicate or copy material from BetNHLFree</li>
        <li>Redistribute content from BetNHLFree</li>
      </ul>
      <br />
      <p>
      ...
      <p>
        ...
        BetNHLFree does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of BetNHLFree,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, BetNHLFree shall not be
      ...
      <br />
      <p>
        BetNHLFree reserves the right to monitor all Comments and to remove any
      ...
      <br />
      <p>
        You hereby grant BetNHLFree a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of BetNHLFree; and (d) the link is
      ...
      <p>
        ...
        e-mail to BetNHLFree. Please include your name, your organization name,
      ...
      <br />
      <p>
        No use of BetNHLFree's logo or other artwork will be allowed for linking
